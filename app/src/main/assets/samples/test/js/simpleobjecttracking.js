...
/*    createOccluder: function createOccluderFn() {
    ...
    createVideo: function createVideoFn() {
         this.video = new AR.VideoDrawable("assets/tushar.mp4", 0.7, {
            onLoaded: this.loadingStep,
            translate: {
				x: -0.2,
				y: -0.12
        ...
        this.video.play(-1);
        this.video.pause();
        World.drawables.push(this.video);
    },
...
/*    getCone: function getConeFn(positionX, positionY, positionZ) {
    ...
    createTracker: function createTrackerFn() {
        this.targetCollectionResource = new AR.TargetCollectionResource("assets/objecttest.wto", {
        });
